...
<head>
    ...
    <meta charset="UTF-8">
    <link rel="stylesheet" href="/estilo_oficales.css">
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul>
                <li>
                    <a href="/1.Home.html" class="">Inicio</a>
                </li>
                <li>
                    <a href="/2.Ikan_ocasion.html" class="">Diseñar Outfit</a>
                </li>
                <li>
                    <a href="">Blog</a>
                </li>
                <li>
                    <a href="/Ikan_tiendas_oficiales.html" class="active">Tiendas</a>
                </li>
                <li>
        ...
        <div class="cuer">
            ...
            <div class="cuero">
                ...
                <div class="intex">
                    ...
                    <center> <a href="/ubicacion.htm">seleccionar</a></center>
